...
input= "/media/busra/SSD/busra/miuul/output/tRNAscan/G_muris.tRNA"
out= "/media/busra/SSD/busra/miuul/output/plot/tRNAscan/G_muris_tRNA_all.svg"
...
plt.scatter(df['Begin'], df['y'], alpha=0.5, color='green', label='Begin')
#plt.scatter(df['End'], df['y'], alpha=0.5, color='blue', label='End')

plt.xlabel('Position in Genome')
plt.ylabel('tRNA')
plt.title('Distribution of G.muris tRNAs Across the Genome')
